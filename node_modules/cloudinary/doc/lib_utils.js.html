...
(function() {
  ...
  process_if = function(ifValue) {
    var replaceRE;
    if (ifValue) {
      replaceRE = new RegExp("(" + Object.keys(PREDEFINED_VARS).join("|") + "|[=&lt;>&amp;|!]+)", "g");
